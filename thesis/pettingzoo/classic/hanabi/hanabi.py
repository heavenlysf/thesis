...
try:
    ...
    raise ImportError(
        (
            ...
            "Run ´pip3 install hanabi_learning_environment´ from within your project env_runner.\n",
...
class raw_env(AECEnv, EzPickle):
    """This class capsules endpoints provided within deepmind/hanabi-learning-env_runner/rl_env.py."""
    ...
    def reset(self):
        """Resets the env_runner for a new game and returns observations of current player as List of ints
        ...
        # Reset underlying hanabi reinforcement learning env_runner
    ...
    def step(
        ...
        """Advances the env_runner by one step. Action must be within self.legal_moves, otherwise throws error.
