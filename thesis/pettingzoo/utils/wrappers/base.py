...
class BaseWrapper(AECEnv):
    """
    Creates a wrapper around `envs` parameter. Extend this class
    ...
    def __init__(self, env):
        ...
        # self.agent_selection = self.envs.agent_selection

        # self.rewards = self.envs.rewards
        # self.dones = self.envs.dones
        ...
        # Not every env_runner has the .state_space attribute implemented
        try:
