...
class ComaDataAugmentation:
    def __init__(self, n_agent, n_env, max_step, gamma, lambda_, log_to_wandb=False, n_duplicate=1):
        ...
        self.actor = MLPActor(self.obs_size, self.n_action, hidden_size=64)
        self.critic = MLPCritic(self.obs_size, self.n_agent, self.n_action, global_encode_size=64, local_encode_size=64,
    ...
    def run(self, iterations):
        for iteration in range(iterations):
            ...
            learner = ComaDataAugmentLearner(self.logger, self.actor, self.critic, self.actor_optimizer,
