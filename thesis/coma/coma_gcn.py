...
from ..model.critic.gcn_critic import GCNCritic
...
class ComaGCN(IComa):
    def __init__(self, n_agent, n_env, max_step, gamma, lambda_,
                 ...
                 fc1_size, fc2_size, actor_lr, critic_lr, grad_norm_clip, log_to_wandb=False):
        ...
        self.critic = GCNCritic(self.obs_size, self.n_agent, self.n_action, gcn_n_layer, gcn_hidden_size,
                                gcn_pool_function, global_encode_size, local_encode_size, fc1_size, fc2_size)
